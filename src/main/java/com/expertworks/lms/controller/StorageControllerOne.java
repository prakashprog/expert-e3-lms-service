...
@RestController
@Component
public class StorageControllerOne {
	...
	public void lmsVideos() throws Exception {
		...
		//
		BasicAWSCredentials awsCreds = new BasicAWSCredentials("AKIAZTGOLXTIJKYEGYJZ",
				"dQpVi/VwGUeydrMVzGyUUWKg885goDEFe+fitch/");
...
//					AmazonS3 s3Client = AmazonS3ClientBuilder.defaultClient();
		...
		String folderName = "folder1";
		 String fileNameInS3 = "javaFile123677.txt";
		...
		File file1 = new File("javaFile12344555.txt");
...
//	                    Map rowMetadataMap = objectMetadata.getRawMetadata();
	...
	public static void main(String[] args) throws Exception {
		...
		StorageControllerOne storageControllerOne = new StorageControllerOne();

		storageControllerOne.lmsVideos();
