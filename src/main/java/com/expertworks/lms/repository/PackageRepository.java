...
public class PackageRepository {
	...
	public Pack getPack(String packId) {
		return dynamoDBMapper.load(Pack.class, packId);
	}
	...
	public String update(String contactId, Contact contact) {
		dynamoDBMapper.save(contactId, new DynamoDBSaveExpression().withExpectedEntry("teamId",
				new ExpectedAttributeValue(new AttributeValue().withS(contactId))));
		return contactId;
	}
}